...
const QuickFilterCards = ({
  ...
  const cardBase =
    "flex items-center gap-3 rounded-2xl border-2 bg-sky-50 px-4 py-4 min-h-[64px] text-left transition-all active:scale-[0.98] hover:bg-sky-100";
  const inactive = "border-sky-100";
  const active = "border-primary ring-2 ring-primary/30 bg-sky-100";
