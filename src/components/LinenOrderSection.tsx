                    ...
                    <div className="rounded-lg border border-border overflow-hidden bg-transparent">
                      {Object.values(order.items as Record<string, number>).some(qty => qty > 0) ? (
                        <Table>
                          <TableHeader>
                            <TableRow>
                              <TableHead className="py-1.5 sm:py-2 px-2 sm:px-4 text-left sm:text-sm text-foreground font-bold text-xs">
                                {t('labels.items')}
                              </TableHead>
                              <TableHead className="py-1.5 sm:py-2 px-2 sm:px-4 text-left sm:text-sm text-foreground font-bold text-xs">
                                {t('labels.color')}
                              </TableHead>
                              <TableHead className="py-1.5 sm:py-2 px-2 sm:px-4 text-right sm:text-sm text-foreground font-bold text-xs">
                                {t('labels.quantity')}
                              </TableHead>
                            </TableRow>
                          </TableHeader>
